...
const redund_splitpath = ["bin", "redund.exe"]
...
const liblrs_splitpath = ["bin", "liblrs-0.dll"]
...
const liblrs = "liblrs-0.dll"


# Relative path to `lrsnash`
const lrsnash_splitpath = ["bin", "lrsnash.exe"]
...
const lrs_splitpath = ["bin", "lrs.exe"]
