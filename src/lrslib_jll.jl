...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import lrslib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3873f7d0-7b7c-52c3-bdf4-8ab39b8f337a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "lrslib", artifacts_toml) for e in artifacts["lrslib"]]
...
if best_platform === nothing
    @debug("Unable to load lrslib; unsupported platform $(triplet(platform_key_abi()))")
else
